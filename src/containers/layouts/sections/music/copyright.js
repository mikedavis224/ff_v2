            ...
            <Row>
                    ...
                    <div className="text-center">
                        <div className="link-horizontal">
                            <ul className="justify-content-center">
                                <li>
                                    <a className="copyright-text op-text" href="https://www.facebook.com/">
                                        <i aria-hidden="true" className="fa fa-facebook"></i>
                                    </a>
                                </li>
                                <li>
                                    <a className="copyright-text op-text" href="https://twitter.com/">
                                        <i aria-hidden="true" className="fa fa-twitter"></i>
                                    </a>
                                </li>
                                <li>
                                    <a className="copyright-text op-text" href="https://accounts.google.com/">
                                        <i aria-hidden="true" className="fa fa-google"></i>
                                    </a>
                                </li>
                                <li>
                                    <a className="copyright-text op-text" href="https://www.instagram.com/">
                ...
                <Col md="5" sm="12">
                    <div className="m-l-auto center-para">
                        <p className="copyright-text text-white text-end op-text">© 2023 Unice powered by Pixelstrap</p>
                    </div>
                </Col>
            </Row>
        </Container>
