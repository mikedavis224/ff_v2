            ...
            <div className="sidebar-container">
                ...
                <div className="post-container d-flex">
                    <div className="w-35 m-r-25">
                        ...
                        <div className="badge badge-yellow">2023</div>
                    </div>
                    <div>
                        <h5 className="post-head">lorem ipsum</h5>
                        <h6 className="date">nov 22, 2023</h6>
                ...
                <div className="post-container d-flex">
                    <div className="w-35 m-r-25">
                        ...
                        <div className="badge badge-blue">2023</div>
                    </div>
                    <div>
                        <h5 className="post-head">lorem ipsum</h5>
                        <h6 className="date">nov 22, 2023</h6>
