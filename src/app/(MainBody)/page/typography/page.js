          ...
          <Col lg="6">
            ...
            <div className="typography-box">
              <div className="headings">
                ...
                <span>
                  Add a <code className="highlighter-rouge">&lt;{`footer className="blockquote-footer"`}&gt;</code> for identifying the source. Wrap the name of the source work in <code className="highlighter-rouge">&lt;cite&gt;</code>.
                </span>
              </div>
              <div className="typo-content">
            ...
            <div className="typography-box">
              ...
              <div className="typo-content typo-buttons">
                <a className="btn btn-default primary-btn me-3 mt-1" href="#">
                  button
                </a>
                <a className="btn btn-default btn-gradient me-3 mt-1" href="#">
                  button
                </a>
                <a className="btn btn btn-default primary-btn rounded-0 me-3 mt-1" href="#">
                  button
                </a>
                <a className="btn btn-default back-white mt-1" href="#">
                  button
                </a>
              </div>
            </div>
            ...
            <div className="typography-box">
              ...
              <div className="typo-content">
                ...
                <p className="text-secondary">
                  This is Secondary text You can archive this adding <code>.text-secondary</code>
                  class
                </p>
                ...
                <p className="text-danger">
                  This is Danger text You can archive this adding <code>.text-danger</code>
                  class
                </p>
                ...
                <p className="text-muted">
                  This is Primary text You can archive this adding <code>.text-muted</code>
                  class
                </p>
              </div>
            </div>
                ...
                <form>
                  <Row>
                    <div className="col-12 mb-3">
                      ...
                      <input className="form-control" id="name" placeholder="Enter Your name" required="" type="text" />
                    </div>
                    <div className="col-12 mb-3">
                    ...
                    <div className="col-12 mb-3">
                      ...
                      <textarea className="form-control" id="exampleFormControlTextarea1" placeholder="Write Your Message" rows="5"></textarea>
                    </div>
                  </Row>
                </form>
              </div>
