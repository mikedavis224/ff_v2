...
const AccordionElementSection = () => {
  const DummyContent1 = () => (
    <div className="collapse show" data-parent="#accordionoc">
      <div className="card-body">No one cares about products. People care about ideas. Is a product an idea? Noup. Is a brand? A good one is. No one cares about products. People care about ideas. Is a product an idea? Noup. Is a brand? A good one is.</div>
    </div>
  );
  const DummyContent2 = () => (
    <div className="collapse show" data-parent="#accordionoc">
                  ...
                  <div className="title title2 title-inner">
                    <div className="main-title">
                      <h2 className="font-primary borders text-center main-text m-b-0">
                        <span className="text-uppercase">default accordion</span>
                      </h2>
                    </div>
                  </div>
                  <Accordion atomic={true}>
