            ...
            <Row>
              <Col lg="8" xs="12" className="offset-lg-2">
                <div className="central-body">
                  ...
                  <p className="text-404 text-white text-center">The Page You Are Attempting To Reach Is Currently Not Available. This May Be Because The Page Does Not Exist Or Has Been Moved.</p>
                  <Link href="/layouts/app1" className="btn btn-default m-t-20">
                    back to home
                  </Link>
                </div>
              </Col>
